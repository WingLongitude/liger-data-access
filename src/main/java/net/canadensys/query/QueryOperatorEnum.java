...
public enum QueryOperatorEnum {
	...
	public int getMinNumberOfValue() {
		return minNumberOfValue;
	}

	public int getMaxNumberOfValue() {
		return maxNumberOfValue;
	}
