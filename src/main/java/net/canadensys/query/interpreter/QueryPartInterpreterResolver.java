...
public class QueryPartInterpreterResolver {
	...
	public static QueryPartInterpreter getQueryPartInterpreter(SearchableFieldTypeEnum searchableFieldTypeEnum) {
		switch (searchableFieldTypeEnum) {
			case SINGLE_VALUE:
				return SINGLE_VALUE_INTERPRETER;
			case MIN_MAX_NUMBER:
				return MIN_MAX_NUMBER_INTERPRETER;
			case START_END_DATE:
				return START_END_DATE_INTERPRETER;
			case INSIDE_ENVELOPE_GEO:
				return INSIDE_ENVELOPE_INTERPRETER;
			case INSIDE_POLYGON_GEO:
				return INSIDE_POLYGON_INTERPRETER;
			case WITHIN_RADIUS_GEO:
				return WITHIN_RADIUS_INTERPRETER;
			default:
				return null;
		}
	}
