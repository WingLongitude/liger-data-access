...
public class PostgisUtils {
	 ...
	 * @param geomColumn
	 * @param asText
	 *            return the bbox as text and not binary
	 * @return
	 */
	 ...
	 * @param isShiftedGeometry
	 *            is the target geometry column a shifted geometry column? In other words, should
	...
	public static String getInsidePolygonSQLClause(String geomColumn, List<Pair<String, String>> polygon, boolean isShiftedGeometry) {
		...
		if (isShiftedGeometry) {
			return String.format(ST_CONTAINS_SQL, String.format(SHIFT_LNG_SQL, String.format(MAKE_POLYGON_SQL, polygonPoints, WSG84_SRID)),
					geomColumn);
		}
	...
	public static String getInsideEnvelopeSQLClause(String geomColumn, List<Pair<String, String>> envelope, boolean isShiftedGeometry) {
		...
		if (isShiftedGeometry) {
			return geomColumn + BBOX_INTERSECT_OPERATOR
					+ String.format(SHIFT_LNG_SQL, String.format(MAKE_ENVELOPE_SQL, StringUtils.join(envelopePoints, ","), WSG84_SRID));
		}
