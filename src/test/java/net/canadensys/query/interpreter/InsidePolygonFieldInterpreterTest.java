...
public class InsidePolygonFieldInterpreterTest {
	...
	public void testGeoCoordinatesFieldInterpreter() {
		...
		assertEquals(
				"ST_Contains(ST_GeomFromText('POLYGON((131.044922 -25.363882,130.053265 -26.985412,130.987986 -26.979865,131.044922 -25.363882))',4326),the_geom)",
		...
		assertEquals(
				"ST_Contains(ST_Shift_Longitude(ST_GeomFromText('POLYGON((131.044922 -25.363882,130.053265 -26.985412,130.987986 -26.979865,131.044922 -25.363882))',4326)),the_shifted_geom)",
				geoCoorInterpreter.toSQL(sqp).toString());
	}
