...
public class TaxonDAOTest extends AbstractTransactionalJUnit4SpringContextTests {
	...
	public void testSetup() {
		...
		jdbcTemplate.batchUpdate(new String[] {
				...
				"INSERT INTO taxonomy (parentid,childid) VALUES (73,9470)", "INSERT INTO taxonomy (parentid,childid) VALUES (9466,1)",
	...
	public void loadTaxonLookupModelStatusRegionCriteria() {
		...
		Iterator<TaxonLookupModel> it = taxonDAO.loadTaxonLookup(200, null, -1, regionQueryPart, new String[] { "native", "ephemere" }, null, false,
				null);
		...
		// only_in and setSearchOnlyInCanada should be read : give me the native and ephemere that are only native or ephemere in AB or BC (ignoring
		// Greenland and St-Pierre)
		regionQueryPart.setRegionSelector(RegionSelector.ONLY_IN);
		...
		// all of, only in and setSearchOnlyInCanada should be read : give me the native,ephemere that are only native or ephemere in AB and BC
		// (ignoring Greenland and St-Pierre status)
		...
		// all of, only in should be read : give me the native,ephemere that are only native or ephemere in AB and BC (including Greenland and
		// St-Pierre status)
		regionQueryPart.setRegionSelector(RegionSelector.ALL_OF_ONLY_IN);
	...
	public void loadTaxonLookupModelStatusRankCriteria() {
		...
		Iterator<TaxonLookupModel> it = taxonDAO.loadTaxonLookup(200, null, -1, regionQueryPart, new String[] { "native", "ephemere" }, new String[] {
				"class", "variety" }, false, null);
		List<String> mockTaxonList = extractMockTaxon(it);
