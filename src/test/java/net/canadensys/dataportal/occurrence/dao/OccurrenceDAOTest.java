...
public class OccurrenceDAOTest extends AbstractTransactionalJUnit4SpringContextTests {
	...
	public void testSearchWithOROperator() {
		...
		assertTrue(id1.equals("1") && id2.equals("4") || id1.equals("4") && id2.equals("1"));
	}
	...
	public void testSearchWithSorting() {
		...
		LimitedResult<List<Map<String, String>>> result = occurrenceDAO.searchWithLimit(searchCriteria, columnList, sorting);
		assertEquals(2, result.getRows().size());
